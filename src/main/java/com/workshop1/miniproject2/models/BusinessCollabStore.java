...
public class BusinessCollabStore {
   ...
   private static BusinessCollabStore instance;


   public BusinessCollabStore() {
       this.businessCollabs.addAll(new BusinessCollab("HighTech","NY","Product"), new BusinessCollab("Lighting","LA","Product"));
   }
   public static BusinessCollabStore getInstance() {
       if(instance == null) {
           instance = new BusinessCollabStore();
       }
       return instance;
   }
